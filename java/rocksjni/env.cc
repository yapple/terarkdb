...
#include "include/org_terarkdb_Env.h"
#include "include/org_terarkdb_RocksEnv.h"
#include "include/org_terarkdb_RocksMemEnv.h"

/*
 * Class:     org_terarkdb_Env
 * Method:    getDefaultEnvInternal
 * Signature: ()J
 */
jlong Java_org_terarkdb_Env_getDefaultEnvInternal(JNIEnv* /*env*/,
                                                 jclass /*jclazz*/) {
...
/*
 * Class:     org_terarkdb_sEnv
 * Method:    getThreadPoolQueueLen
 * Signature: (JI)I
 */
jint Java_org_terarkdb_Env_getThreadPoolQueueLen(JNIEnv* /*env*/,
                                                jobject /*jobj*/, jlong jhandle,
                                                jint pool_id) {
  auto* rocks_env = reinterpret_cast<TERARKDB_NAMESPACE::Env*>(jhandle);
  switch (pool_id) {
    case org_terarkdb_RocksEnv_FLUSH_POOL:
      return rocks_env->GetThreadPoolQueueLen(TERARKDB_NAMESPACE::Env::Priority::LOW);
    case org_terarkdb_RocksEnv_COMPACTION_POOL:
...
/*
 * Class:     org_terarkdb_RocksMemEnv
 * Method:    createMemEnv
 * Signature: ()J
 */
jlong Java_org_terarkdb_RocksMemEnv_createMemEnv(JNIEnv* /*env*/,
                                                jclass /*jclazz*/) {
 ...
 * Signature: (J)V
 */
void Java_org_terarkdb_RocksMemEnv_disposeInternal(JNIEnv* /*env*/,
                                                  jobject /*jobj*/,
                                                  jlong jhandle) {
