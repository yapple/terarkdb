 ...
 *   @see org.terarkdb.Slice
 *   @see org.terarkdb.DirectSlice
 *
 ...
 *   @see org.terarkdb.AbstractSlice subclass Objects. When you dispose
 *   the Java @see org.terarkdb.AbstractComparator subclass, it disposes the
 *   C++ BaseComparatorJniCallback subclass, which in turn destroys the
 *   Java @see org.terarkdb.AbstractSlice subclass Objects.
 */
public abstract class AbstractSlice<T> extends RocksMutableObject {
   ...
   *   @see org.terarkdb.AbstractSlice#data0(long)
   */
  public T data() {
