...
public interface AdvancedColumnFamilyOptionsInterface
   ...
   *     {@link org.terarkdb.CompressionType} instances.
   *
   * @return the reference to the current options.
   */
  ...
  /**
   * <p>Return the currently set {@link org.terarkdb.CompressionType}
   * per instances.</p>
   *
   * <p>See: {@link #setCompressionPerLevel(java.util.List)}</p>
   *
   * @return list of {@link org.terarkdb.CompressionType}
   *     instances.
   */
