...
public class BlockBasedTableConfig extends TableFormatConfig {
   ...
   *
   * {@link org.terarkdb.Cache} should not be disposed before options instances
   * using this cache is disposed.
   *
   * {@link org.terarkdb.Cache} instance can be re-used in multiple options
   * instances.
   *
   * @param cache {@link org.terarkdb.Cache} Cache java instance (e.g. LRUCache).
   * @return the reference to the current config.
   */
   ...
   *
   * {@link org.terarkdb.Filter} should not be disposed before options instances
   * using this filter is disposed. If {@link Filter#dispose()} function is not
   * called, then filter object will be GC'd automatically.
   *
   * {@link org.terarkdb.Filter} instance can be re-used in multiple options
   * instances.
   *
   * @param filter {@link org.terarkdb.Filter} Filter Policy java instance.
   * @return the reference to the current config.
   */
   ...
   *
   * @param checksumType {@link org.terarkdb.ChecksumType} value.
   * @return the reference to the current option.
   */
   ...
   *
   * @param indexType {@link org.terarkdb.IndexType} value
   * @return the reference to the current option.
   */
