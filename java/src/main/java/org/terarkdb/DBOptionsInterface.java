...
public interface DBOptionsInterface<T extends DBOptionsInterface> {
   ...
   *     specified database in {@link RocksDB#open(org.terarkdb.Options, String)} operation
   *     is missing.
   * @return the instance of the current Options
   * @see RocksDB#open(org.terarkdb.Options, String)
   */
   ...
   * Default: nullptr
   *
   * @param rateLimiter {@link org.terarkdb.RateLimiter} instance.
   * @return the instance of the current object.
   *
   * @since 3.10.0
   */
