 ...
 *
 * <p>
 * A log level can be set using {@link org.terarkdb.Options} or
 ...
 * {@link org.terarkdb.InfoLogLevel#ERROR_LEVEL} or
 * {@link org.terarkdb.InfoLogLevel#FATAL_LEVEL}.
 * </p>
 */
public abstract class Logger extends RocksCallbackObject {
   ...
   * the {@link org.terarkdb.Options} instance will be used as
   ...
   *
   * <p><strong>Important:</strong> the log level set within
   * the {@link org.terarkdb.DBOptions} instance will be used
   * as maximum log level of RocksDB.</p>
   *
   * @param dboptions {@link org.terarkdb.DBOptions} instance.
   */
   ...
   *
   * @param infoLogLevel {@link org.terarkdb.InfoLogLevel} instance.
   */
   ...
   *
   * @return {@link org.terarkdb.InfoLogLevel} instance.
   */
