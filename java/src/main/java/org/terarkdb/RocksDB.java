...
import org.terarkdb.util.Environment;
...
public class RocksDB extends RocksObject {
   ...
   *
   * @param options {@link org.terarkdb.Options} instance.
   * @param path the path to the rocksdb.
   * @return a {@link RocksDB} instance on success, null if the specified
   *     {@link RocksDB} can not be opened.
   *
   ...
   * </p>
   *
   * @param options {@link org.terarkdb.DBOptions} instance.
   * @param path the path to the rocksdb.
   * @param columnFamilyDescriptors list of column family descriptors
   * @param columnFamilyHandles will be filled with ColumnFamilyHandle instances
   *     on open.
   ...
   * column family.
   *
   * @param columnFamilyHandle {@link org.terarkdb.ColumnFamilyHandle}
   *     instance
   * @param key the specified key to be inserted.
   * @param value the value associated with the specified key.
   *
   ...
   * Set the database entry for "key" to "value".
   *
   * @param writeOpts {@link org.terarkdb.WriteOptions} instance.
   * @param key the specified key to be inserted.
   * @param value the value associated with the specified key.
   *
   * @throws RocksDBException thrown if error happens in underlying
   ...
   *     {@link org.terarkdb.ColumnFamilyHandle} instances.
   * @param keys List of keys for which values need to be retrieved.
   * @return Map where key of map is the key passed by user and value for map
   * entry is the corresponding value in DB.
   *
   ...
   *          {@link org.terarkdb.ColumnFamilyHandle} instance
   * @param beginKey
   *          First key to delete within database (included)
   * @param endKey
   *          Last key to delete within database (excluded)
 ...
 /**
   ...
   * @param columnFamilyHandleList {@link java.util.List} containing
   *     {@link org.terarkdb.ColumnFamilyHandle} instances.
   * @return {@link java.util.List} containing {@link org.terarkdb.RocksIterator}
   *     instances
   *
   * @throws RocksDBException thrown if error happens in underlying
   *    native library.
   ...
   * @return {@link org.terarkdb.ColumnFamilyHandle} instance.
   *
   * @throws RocksDBException thrown if error happens in underlying
   *    native library.
   */
   ...
   *
   * @param flushOptions {@link org.terarkdb.FlushOptions} instance.
   ...
   *
   * @param flushOptions {@link org.terarkdb.FlushOptions} instance.
   * @param columnFamilyHandle {@link org.terarkdb.ColumnFamilyHandle} instance.
   * @throws RocksDBException thrown if an error occurs within the native
   *     part of the library.
   */
  public void flush(final FlushOptions flushOptions,
   ...
   *
   * @return {@link org.terarkdb.TransactionLogIterator} instance.
   *
   * @throws org.terarkdb.RocksDBException if iterator cannot be retrieved
   *     from native-side.
   */
