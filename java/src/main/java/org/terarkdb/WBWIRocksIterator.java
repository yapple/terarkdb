...
public class WBWIRocksIterator
   ...
   * {@link org.terarkdb.WBWIRocksIterator#entry()}
   *
   * It is worth noting that a WriteEntry with
   * the type {@link org.terarkdb.WBWIRocksIterator.WriteType#DELETE}
   * or {@link org.terarkdb.WBWIRocksIterator.WriteType#LOG}
  ...
  public static class WriteEntry implements AutoCloseable {
     ...
     * by calling {@link org.terarkdb.WBWIRocksIterator#entry()}
     */
    private WriteEntry() {
      key = new DirectSlice();
