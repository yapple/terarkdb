...
/**
 * Similar to {@link org.terarkdb.WriteBatch} but with a binary searchable
 * index built for all the keys inserted.
 *
 * Calling put, merge, remove or putLogData calls the same function
 * as with {@link org.terarkdb.WriteBatch} whilst also building an index.
 *
 * A user can call {@link org.terarkdb.WriteBatchWithIndex#newIterator()} to
 * create an iterator over the write batch or
 * {@link org.terarkdb.WriteBatchWithIndex#newIteratorWithBase(org.terarkdb.RocksIterator)}
...
public class WriteBatchWithIndex extends AbstractWriteBatch {
   ...
   * {@link org.terarkdb.RocksIteratorInterface#seek(byte[])} to
   ...
   * creating a new Iterator that will use {@link org.terarkdb.WBWIRocksIterator}
   ...
   *   e.g. {@link org.terarkdb.RocksDB#newIterator()}
